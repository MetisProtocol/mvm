...
func Run(ctx *cli.Context) error {
  ...
  outLog := &mipsevm.LoggingWriter{Log: Logger(os.Stdout, slog.LevelDebug, "module", "guest", "stream", "stdout")}
  errLog := &mipsevm.LoggingWriter{Log: Logger(os.Stdout, slog.LevelDebug, "module", "guest", "stream", "stderr")}
