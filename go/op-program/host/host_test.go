...
func TestServerMode(t *testing.T) {
	...
	cfg := config.NewConfig(chainconfig.MetisSepoliaRollupConfig, chainconfig.MetisSepoliaChainConfig, l1Head, common.Hash{0x22}, l2OutputRoot, common.Hash{0x44}, 1000)
	cfg.DataDir = dir
	cfg.ServerMode = true
