...
proto.disperser.BlobHeader.toObject = function(includeInstance, msg) {
  var f, obj = {
    commitment: (f = msg.getCommitment()) && common_pb.G1Commitment.toObject(includeInstance, f),
...
proto.disperser.BlobHeader.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new common_pb.G1Commitment;
      reader.readMessage(value,common_pb.G1Commitment.deserializeBinaryFromReader);
...
proto.disperser.BlobHeader.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      common_pb.G1Commitment.serializeBinaryToWriter
    );
  }
...
proto.disperser.BlobHeader.prototype.getCommitment = function() {
  return /** @type{?proto.common.G1Commitment} */ (
    jspb.Message.getWrapperField(this, common_pb.G1Commitment, 1));
};
