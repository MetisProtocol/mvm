...
contract MVM_InboxSenderManager is iMVM_InboxSenderManager, Lib_AddressResolver {
    ...
    constructor(
        ...
        InboxSender[] memory _defaultInboxSenders
    ...
    function overwriteLastInboxSenders(
        ...
        mapping(InboxSenderType => InboxSender) storage lastInboxSenders = inboxSenders[
            lastBlockNumber
        ];
     ...
     * Internal Functions *
     ********************/
    function _setInboxSenders(uint256 blockNumber, InboxSender[] calldata _inboxSenders) private {
